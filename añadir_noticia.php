                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="añadir_noticia.php" class="nav-link active">
                                        <i class="nav-icon fas fa-plus"></i>
                                        <p>Añadir noticia</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Añadir Noticia</h1>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
                                ...
                                <div class="card-body border-end border-5">
                                    <form class="mx-5 mt-4 needs-validation" novalidate action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="descripN" class="form-label">Descripción de la Noticia</label>
                                            ...
                                            <div class="form-group">
                                                <label for="fechaN" class="form-label">Fecha de Creación de la Noticia</label>
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="añadirNoticia" class="btn btn-primary btn-lg">Subir Noticia</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="text-center mb-3 fs-3 text-success">
                                    <?php
                                    if (isset($_POST['añadirNoticia'])) {
